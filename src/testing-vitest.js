...
const isMinifiedModule = new URL(import.meta.url).pathname.endsWith('.min.js'),
    ...
    { createACLTestHarness } = await importLocalModule('./testing.js');
...
export const createACLVitestFixture = ({ beforeEach, afterEach }, options = {}) => {
    if (typeof beforeEach !== 'function' || typeof afterEach !== 'function')
        throw new TypeError('[ACL Testing] Vitest beforeEach and afterEach hooks are required.');
    let harness = null;
    beforeEach(() => {
...
export default { createACLVitestFixture };
